"""
Django settings for bank_united_45804 project.
...
ROOT_URLCONF = 'bank_united_45804.urls'
...
WSGI_APPLICATION = 'bank_united_45804.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bank_united_45804 API",
    "DESCRIPTION": "API documentation for bank_united_45804 App",
    "VERSION": "v1",
}
